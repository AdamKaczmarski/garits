...
insert into customers (name,city,address,postcode,telephone_number,email) values('tom2','london','street','123ewq',82374292,'tes2t@test.com');
...
insert into jobs_parts (part_id,job_id,quantity_used) values(1,1,2);
...
select * from jobs_services;
insert into jobs_services (job_id,service_id) values (1,1),(1,2),(5,1);

select group_concat(short_description SEPARATOR ';; ') from services;